...
describe('SettingsPanel', () => {
  const tMock = (key: string) => {
    const map: Record<string, string> = {
      ...
      'appearance.description': 'Customize look',
      'appearance.themeLabel': 'Theme',
      'appearance.light': 'Light',
      'appearance.dark': 'Dark',
      'appearance.system': 'System',
      'language.title': 'Language',
      'language.description': 'Change display language',
      'language.selectLabel': 'Select language',
      'language.save': 'Save Language',
      'language.confirm.title': 'Change Language',
      'language.confirm.description': 'Confirm language change?',
      'language.confirm.confirmText': 'Yes, change',
      'reset.title': 'Reset',
      'reset.description': 'Restore defaults',
      'reset.button': 'Reset Settings',
      'reset.confirm.title': 'Reset Preferences',
      'reset.confirm.description': 'Confirm reset?',
      'reset.confirm.confirmText': 'Yes, reset',
